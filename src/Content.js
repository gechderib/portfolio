...
export const content = {
  ...
  hero: {
    id: "hero",
    slug: "hero-intro",
    title: "AI-First Backend Engineer",
    firstName: "Getachew",
    lastName: "Derib",
    btnText: "Hire Me",
    ...
    hero_content: [
      { id: "hc-1", count: "5+", text: "Years of experience in software engineering and backend development" },
      { id: "hc-2", count: "2M+", text: "Data records processed for AI-driven predictions and insights" },
      { id: "hc-3", count: "10+", text: "AI & FinTech projects delivered across backend platforms" },
    ],
    createdAt: now,
    updatedAt: now,
  },
    ...
    skills_content: [
      {
        ...
        para: "End-to-end AI development from data wrangling to scalable API deployment.",
        logo: asset("Skills/python.png"),
        tags: ["ai", "machine-learning", "data-science", "lightgbm", "scikit-learn"],
        skills: [
          "Basic: Exploratory data analysis, cleaning, and manipulation (Pandas, NumPy).",
          "Intermediate: Feature engineering, pipeline creation, and data preprocessing.",
          "Advanced: Training and fine-tuning predictive ML models on big data (2M+ records).",
          "Advanced: Credit scoring & risk assessment models tailored for FinTech applications.",
          "Deployment: Serving high-performance ML inference APIs using FastAPI and Docker."
        ],
        createdAt: now,
        updatedAt: now,
      },
  ...
  services: {
    ...
    service_content: [
      ...
      },
      {
        ...
        para: "Integrating AI models into robust web applications. Deploying scalable machine learning APIs with FastAPI to serve predictions for FinTech, loan approvals, and data-driven systems.",
        logo: asset("Services/logo1.png"),
        tags: ["ai-integration", "fastapi"],
        createdAt: now,
        updatedAt: now,
      },
      {
  ...
  Projects: {
    ...
    project_content: [
      { id: "proj-ai-1", title: "AI Loan Approval Predictor", image: asset("Projects/ai_loan.png"), link: "https://ai-loan-approval.onrender.com/docs#/", createdAt: now },
      { id: "proj-ai-2", title: "FinTech Credit Score Risk Analyzer", image: asset("Projects/credit_score.png"), link: "https://github.com/gechderib", createdAt: now },
  ...
  Hireme: {
    ...
    para: "I’m Getachew Derib, an AI-first backend engineer with 5+ years of experience. I specialize in building intelligent backend systems, processing big data (2M+ records), and deploying high-performance ML inference APIs using FastAPI. Alongside AI, I develop secure FinTech platforms, digital wallets, and crowdfunding solutions.",
    btnText: "Hire Me",
    createdAt: now,
    updatedAt: now,
  },
